...
Usage example:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
python3 2Heat_6.25Zr.py \
  --plus-den  "/home/yanan/Material/Y_dope_project/6.25Per-Zr-HfO2-2x2x2/berry-scf-Results/berry_PlusP_6.25Zr_HfO2_12248413/berry_PlusP_6o_DEN.nc" \
  --minus-den "/home/yanan/Material/Y_dope_project/6.25Per-Zr-HfO2-2x2x2/berry-scf-Results/berry_MinusP_6.25Zr_HfO2_12248602/berry_MinusP_6o_DEN.nc" \
  --plus-in   "/home/yanan/Material/Y_dope_project/6.25Per-Zr-HfO2-2x2x2/berry-scf-Results/berry_PlusP_6.25Zr_HfO2_12248413/berry_PlusP_6.25Per_Zr_HfO2_2x2x2.in" \
  --minus-in  "/home/yanan/Material/Y_dope_project/6.25Per-Zr-HfO2-2x2x2/berry-scf-Results/berry_MinusP_6.25Zr_HfO2_12248602/berry_MinusP_6.25Per_Zr_HfO2_2x2x2.in" \
  --units ang \
  --outdir 2_DEN_Figures_SHARP_6.25Zr \
  --write-cube \
  --cmap-plus viridis \
  --cmap-minus plasma \
  --cmap-drho seismic
...
def main():
    ...
    ap.add_argument("--outdir", default="3_DEN_Figures_SHARP_6.25Zr", help="Base output directory name")
    ...
    # Ensure output folder includes 6.25Zr
