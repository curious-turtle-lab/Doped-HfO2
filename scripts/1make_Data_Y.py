...
# ============================================================
# Y-doped HfO2 Berry-phase output files
# ============================================================
CASES = [
    {
        "doping_percent": 3.125,
        "plus_out": Path("/home/yanan/Material/Y_dope_project/3.125Per-Y-HfO2-2x2x2/berry-scf-results/berry_PlusP_3.125Per_Y_HfO2_12118862/berry_PlusP_3.125Per_Y_HfO2_2x2x2.out"),
        "minus_out": Path("/home/yanan/Material/Y_dope_project/3.125Per-Y-HfO2-2x2x2/berry-scf-results/berry_MinusP_3.125Per_Y_HfO2_12118864/berry_MinusP_3.125Per_Y_HfO2_2x2x2.out"),
    },
    {
        "doping_percent": 6.25,
        "plus_out": Path("/home/yanan/Material/Y_dope_project/6.25Per-Y-HfO2-2x2x2/berry-scf-results/berry_PlusP_6.25Y_HfO2_12651723/berry_PlusP_6.25Per_Y_HfO2_2x2x2.out"),
        "minus_out": Path("/home/yanan/Material/Y_dope_project/6.25Per-Y-HfO2-2x2x2/berry-scf-results/berry_MinusP_6.25Y_HfO2_12397618/berry_MinusP_6.25Per_Y_HfO2_2x2x2.out"),
    },
    {
        "doping_percent": 9.375,
        "plus_out": Path("/home/yanan/Material/Y_dope_project/9.375Y-HfO2-2x2x2/9.375Y-scf-berry-2x2x2-Results/berry_PlusP_9.375Y_HfO2_12122002/berry_PlusP_9.375Per_Y_HfO2_2x2x2.out"),
        "minus_out": Path("/home/yanan/Material/Y_dope_project/9.375Y-HfO2-2x2x2/9.375Y-scf-berry-2x2x2-Results/berry_MinusP_9.375Y_HfO2_12121996/berry_MinusP_9.375Per_Y_HfO2_2x2x2.out"),
    },
]

OUTPUT_TXT = Path("Data-Y.txt")
...
def write_output(results: List[Dict], outfile: Path) -> None:
    with outfile.open("w", encoding="utf-8") as f:
        f.write("Y-doped HfO2 spontaneous polarization summary\n")
        f.write("=" * 90 + "\n\n")

        f.write("Compact table\n")
        f.write("-" * 90 + "\n")
        f.write(
            f"{'Y(%)':>8}  {'rfdir':>10}  {'Axis':>6}  "
        ...
        for r in results:
            f.write(f"Y doping (%)            : {r['doping_percent']:.3f}\n")
