...
2Heat_3.125Y.py
##########################################################################################
python3 2Heat_3.125Y.py   --plus-den  "/home/yanan/Material/Y_dope_project/3.125Per-Y-HfO2-2x2x2/berry-scf-results/berry_PlusP_3.125Per_Y_HfO2_12118862/berry_PlusP_3o_DEN.nc"   --minus-den "/home/yanan/Material/Y_dope_project/3.125Per-Y-HfO2-2x2x2/berry-scf-results/berry_MinusP_3.125Per_Y_HfO2_12118864/berry_MinusP_3o_DEN.nc"   --plus-in   "/home/yanan/Material/Y_dope_project/3.125Per-Y-HfO2-2x2x2/berry-scf-results/berry_PlusP_3.125Per_Y_HfO2_12118862/berry_PlusP_3.125Per_Y_HfO2_2x2x2.in"   --minus-in  "/home/yanan/Material/Y_dope_project/3.125Per-Y-HfO2-2x2x2/berry-scf-results/berry_MinusP_3.125Per_Y_HfO2_12118864/berry_MinusP_3.125Per_Y_HfO2_2x2x2.in"   --units ang --outdir 2_DEN_Figures_SHARP_3.125Y --write-cube

############################################################################################
2D heatmaps (rho(+P), rho(-P), delta_rho) from ABINIT DEN.nc (+P/-P) and optional VESTA cube export.

Key features:
- Adds "3.125% Y-doping" to titles
- Ensures output folder includes "3.125Y"
...
def main():
    ...
    ap.add_argument("--outdir", default="2_DEN_Figures_SHARP_3.125Y", help="Base output directory name")
    ...
    # Ensure output folder includes 3.125Y
