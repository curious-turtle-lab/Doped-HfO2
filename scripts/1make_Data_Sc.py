...
# ============================================================
# Sc-doped HfO2 Berry-phase output files
# Edit these paths if needed
# ============================================================
CASES = [
    {
        "doping_percent": 3.125,
        "plus_out": Path("/home/yanan/Material/Y_dope_project/3.125Per-Sc-HfO2-2x2x2/berry-scf-Results/berry_PlusP_3.125Sc_HfO2_12144296/berry_PlusP_3.125Per_Sc_HfO2_2x2x2.out"),
        "minus_out": Path("/home/yanan/Material/Y_dope_project/3.125Per-Sc-HfO2-2x2x2/berry-scf-Results/berry_MinusP_3.125Sc_HfO2_12144332/berry_MinusP_3.125Per_Sc_HfO2_2x2x2.out"),
    },
    {
        "doping_percent": 6.25,
        "plus_out": Path("/home/yanan/Material/Y_dope_project/6.25Per-Sc-HfO2-2x2x2/berry-scf-results/berry_PlusP_6.25Sc_HfO2_12144349/berry_PlusP_6.25Per_Sc_HfO2_2x2x2.out"),
        "minus_out": Path("/home/yanan/Material/Y_dope_project/6.25Per-Sc-HfO2-2x2x2/berry-scf-results/berry_MinusP_6.25Sc_HfO2_12144457/berry_MinusP_6.25Per_Sc_HfO2_2x2x2.out"),
    },
    {
        "doping_percent": 9.375,
        "plus_out": Path("/home/yanan/Material/Y_dope_project/9.375Sc-HfO2-2x2x2/berry-scf-Results/berry_PlusP_9.375Sc_HfO2_12144507/berry_PlusP_9.375Per_Sc_HfO2_2x2x2.out"),
        "minus_out": Path("/home/yanan/Material/Y_dope_project/9.375Sc-HfO2-2x2x2/berry-scf-Results/berry_MinusP_9.375Sc_HfO2_12144529/berry_MinusP_9.375Per_Sc_HfO2_2x2x2.out"),
    },
]


OUTPUT_TXT = Path("Data-Sc.txt")
...
def write_output(results: List[Dict], outfile: Path) -> None:
    with outfile.open("w", encoding="utf-8") as f:
        f.write("Sc-doped HfO2 spontaneous polarization summary\n")
        f.write("=" * 90 + "\n\n")

        f.write("Compact table\n")
        f.write("-" * 90 + "\n")
        f.write(
            f"{'Sc(%)':>8}  {'rfdir':>10}  {'Axis':>6}  "
        ...
        for r in results:
            f.write(f"Sc doping (%)           : {r['doping_percent']:.3f}\n")
